...
Param(
  ...
  [string] $TemplateFile = '..\Templates\SilicusUtilityContainerWithAzureAdWeb.json',
  [string] $TemplateParametersFile = '..\Templates\SilicusUtilityContainerWithAzureAdWeb.param.dev.json',
