...
namespace Silicus.ProjectTracker.Entities
{
    ...
    /// the data store.
    /// </summary>
    public class ProjectTrackerIpDataContext : DataContextBase, IDataContext
    {
        public ProjectTrackerIpDataContext(string connectionString)
            : base(connectionString)
        {
            Database.SetInitializer<ProjectTrackerIpDataContext>(null);
        }
