...
Param(
  ...
  [string] $TemplateFile = '..\Templates\SilicusEncourageWithAzureAdWeb.json',
  [string] $TemplateParametersFile = '..\Templates\SilicusEncourageWithAzureAdWeb.param.dev.json',
